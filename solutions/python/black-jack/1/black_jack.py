...
def value_of_ace(card_one, card_two):
    ...
    # diff = 21 - (value_card_one + value_card_two)
    # return 11 if 21 - diff <= 11 else 1
...
def is_blackjack(card_one, card_two):
    ...
    # value_card_one = value_of_card(card_one) if card_one != "A" else 11
    # value_card_two = value_of_card(card_two) if card_two != "A" else 11
