...
def check_drinks(drink_name, drink_ingredients):
    ...
    """
    suffix = "Mocktail" if set(drink_ingredients).isdisjoint(ALCOHOLS) else "Cocktail"
...
def categorize_dish(dish_name, dish_ingredients):
    ...
    category = next(
        (cat for cat, ingredients in CATEGORIES.items() if dish_ingredients.issubset(ingredients)),
        ""
    )
